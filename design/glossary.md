...
- **Control Plane**: Manages projects, mounts, tokens, nodes, and the Venom catalog.
- **Node**: A host/runtime that exports filesystem or Venom namespaces.
- **Venom Catalog**: Control-plane list of Venoms advertised by a node.
